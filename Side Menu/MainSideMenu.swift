...
enum Tab: String, CaseIterable {
    case watchlists = "figure.arms.open", explore = "checklist", finances = "newspaper", ai = "wand.and.stars", categories = "storefront", notifications = "safari"
    ...
    var title: String {
        switch self {
        case .watchlists: return "MyFettle"
        case .explore: return "Dashboard"
        case .finances: return "Media"
        case .ai: return "AI"
        case .categories: return "Marketplace"
        case .notifications: return "Explore"
