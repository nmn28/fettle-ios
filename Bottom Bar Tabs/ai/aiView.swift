...
struct aiView: View {
    ...
    let buttonLabels = ["Which Categories are trending?", "Explain Caridovascular Disease like im 5 years old",
                        "What determines biological age?", "Best workout plan for back pain?"]
            ...
            GeometryReader { geometry in
                ZStack {
                    ...
                    VStack(spacing: 20) { // Added spacing between elements
                        ...
                        VStack {
                            HStack(spacing: 0) {
                                ForEach(Array("fettle.ai".enumerated()), id: \.offset) { index, character in
